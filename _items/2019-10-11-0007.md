...
---
## About This Object
This is a pin that was created by David Orr.  Orr is a local artist that creates items that are known as "paleoart."  This item has a dinosaur skull that is encompassed by a flame burning in different colors.  Flame edges are breaking off and the pin looks to be long in length. {% if page.itemcontributor %}**—{{ page.itemcontributor }}**{% endif %}
